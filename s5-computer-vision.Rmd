...
- training networks is fiddly, time consuming, and requires lots of data
...
```{r}
video_file <- system.file("extdata/video/2019_03_01-KATS-BEDS-clip.mp4", package = "ovdata")
video_file
