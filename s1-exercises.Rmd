...
8. What was the average winning margin of a set?

9. Does that vary by set number 1--5?

10. Plot a histogram of the score margin (all sets combined)

11. Same thing with each set shown separately

12. Find the most one-sided set result

13. Is there a home team advantage? Find the match win rate for the home team (ignore the fact that some of these matches were played at neutral venues --- just take the `home_team` and `visiting_team` column names on face value)
